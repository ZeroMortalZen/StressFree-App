...
public class MeditationPlayerActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meditation_player3);
        progressBar = findViewById(R.id.progress_barAudio);

        // Initialize Firebase Storage reference
        mStorageRef = FirebaseStorage.getInstance().getReference();

        NightMedGif = findViewById(R.id.imageViewNight);
    ...
    private void loadGifFromFirebaseStorage() {
        ...
        Glide.with(MeditationPlayerActivity3.this)
                .asGif()
                .load(gifUrl)
                .into(NightMedGif);
    }
    ...
    private void loadAudioFromFirebaseStorageAndPlay() {
        String audioPath = "Voiceovers/nightVoice/nightvoice.wav";
